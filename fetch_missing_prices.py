...
def get_place_details(place_id):
    ...
    params = {
        "fields": "id,displayName,formattedAddress,rating,userRatingCount,reviews,types,location,websiteUri,internationalPhoneNumber,priceLevel,goodForChildren,menuForChildren",
        "key": API_KEY,
