$updates = @(
    @{ id = "ChIJvWWkxO6rQjQRHf_zc9VTcAE"; tags = @("child_seat", "kids_menu") },
    @{ id = "ChIJm61UaXquQjQR_22Fk4OAnf0"; tags = @("child_seat") },
    @{ id = "ChIJyWRT3mWrQjQRFOM_DSk68CE"; tags = @("child_seat", "spacious_seating", "kids_menu", "kid_noise_tolerant") },
    @{ id = "ChIJCyKuHW-sQjQRLbLgae6QWSU"; tags = @("child_seat", "spacious_seating", "kids_menu", "kid_noise_tolerant") },
    @{ id = "ChIJu7S709OpQjQR6L04WjL3B-c"; tags = @("child_seat") },
    @{ id = "ChIJR-aMAnKuQjQRy9v-O6K_f_U"; tags = @("child_seat", "kids_menu") },
    @{ id = "ChIJpU9Y8aesQjQRvQf3z_v69O0"; tags = @("child_seat") },
    @{ id = "ChIJrSZypLCrQjQRdNWuZqKdwqM"; tags = @("child_seat") },
    @{ id = "ChIJkwFdzqesQjQRKG_OT1ubKVg"; tags = @("child_seat", "kids_menu", "kid_noise_tolerant") },
    @{ id = "ChIJvU5mgSmqQjQR0WhA_Zruk5E"; tags = @("child_seat", "kids_menu", "kid_noise_tolerant") }
)
...
foreach ($u in $updates) {
    ...
    if ($null -eq $review) { Write-Host "Error parsing $filePath"; continue }
    ...
    elseif ($pos -ge 1) { $review | Add-Member -MemberType NoteProperty -Name 'parent_friendly_level' -Value $mid -Force }
